...
/////////////////
const BotName = 'QIHIYY BOT☄'; 
const instagram = 'https://instagram.com/qihiyy28'; 
const telegram = 'https://t.me/Xeonntr'; 
const kapanbotaktif = 'KALO GAK MAGER'; 
const youtube = 'https://youtube.com/c/UCr1OP83dySrFSOCsXPqCKdw';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@qihiyy28')
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by ig:@qihiyy28`)
})
